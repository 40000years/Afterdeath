...
public enum CropType {
    ...
    CHAMELEON_LEAF("chameleon_leaf", CropTier.TIER_1, "ผักกาดหอม", "Lettuce",
        ...
        List.of(
            ...
            "§e✦ มอนสเตอร์จะไม่โจมตีก่อนเป็นเวลา 45 วินาที",
            "§8ระยะเวลาเติบโต: 3 นาที · ปลูกบน Farmland"
        )),
    ...
    THUNDER_KERNEL_CORN("thunder_kernel_corn", CropTier.TIER_2, "ข้าวโพด", "Corn",
        ...
        List.of(
            ...
            "§e✦ การโจมตีจะชิ่งสายฟ้าใส่ศัตรูใกล้เคียง 3 ตัว (6 ดาเมจ)",
            "§6✦ กวาดล้างฝูงมอนสเตอร์ได้อย่างรวดเร็ว นาน 60 วินาที",
            "§8ระยะเวลาเติบโต: 5 นาที · ปลูกบน Farmland"
        )),
    ...
    ABYSSAL_KELP("abyssal_kelp", CropTier.TIER_3, "ขึ้นฉ่าย", "Celery",
        ...
        List.of(
            "§7สาหร่ายเรืองแสงจากร่องลึกบาดาลมืดมิด",
            "§3✦ เปิดเนตรญาณหยั่งรู้: แสดงเส้นขอบเรืองแสง (Glowing)",
            "§b✦ ให้กับมอนสเตอร์ บอส และหีบสมบัติในระยะ 24 บล็อก นาน 30 วินาที",
            "§8ระยะเวลาเติบโต: 7.5 นาที · ปลูกบน Farmland"
        )),
    ...
    GOLDLEAF_HERB("goldleaf_herb", CropTier.TIER_4, "ผักโขม", "Spinach",
        ...
        List.of(
            ...
            "§6✦ แปลง 30% ของดาเมจที่ผู้เล่นได้รับ เป็นความทนทานชุดเกราะ",
            "§e✦ ซ่อมแซมชุดเกราะและอาวุธที่สวมใส่อัตโนมัติ นาน 2 นาที",
            "§8ระยะเวลาเติบโต: 10 นาที · ปลูกบน Farmland"
        )),
    ...
    ETHEREAL_MINT("ethereal_mint", CropTier.TIER_5, "สะระแหน่", "Mint",
        ...
        List.of(
            ...
            "§b✦ เวทมนตร์ 3 ครั้งถัดไปจะร่ายซ้ำเบิ้ลทันทีอีก 1 ครั้ง ฟรี!",
            "§f✦ ไม่เสียมานาเพิ่มและไม่ติดคูลดาวน์ซ้ำ (3 ชาร์จ)",
            "§8ระยะเวลาเติบโต: 15 นาที · ปลูกบน Farmland"
        )),
    ...
    OMNI_POMEGRANATE("omni_pomegranate", CropTier.TIER_5, "ทับทิม", "Pomegranate",
        ...
        List.of(
            ...
            "§d✦ ทุกครั้งที่ร่ายเวท จะระเบิดพลังธาตุตรงข้ามรอบตัวผู้ร่าย",
            "§f✦ สร้างดาเมจและผลักศัตรูที่ล้อมรอบออกไป นาน 60 วินาที",
            "§8ระยะเวลาเติบโต: 15 นาที · ปลูกบน Farmland"
        ));
